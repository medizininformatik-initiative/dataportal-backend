...
public class MultiMessageBundle {
  ...
  static {
    bundles.put(DataqueryCsvExportService.SUPPORTED_LANGUAGES.EN, ResourceBundle.getBundle("de.fdpg.dataportal_backend.query.dataquery.CsvMessages", Locale.ENGLISH));
    bundles.put(DataqueryCsvExportService.SUPPORTED_LANGUAGES.DE, ResourceBundle.getBundle("de.fdpg.dataportal_backend.query.dataquery.CsvMessages", Locale.GERMAN));
  }
