package de.fdpg.dataportal_backend.query.broker.aktin;
...
import de.fdpg.dataportal_backend.query.broker.SiteNotFoundException;
...
import static de.fdpg.dataportal_backend.query.persistence.BrokerClientType.AKTIN;
