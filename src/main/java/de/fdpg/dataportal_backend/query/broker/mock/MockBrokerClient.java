package de.fdpg.dataportal_backend.query.broker.mock;
...
import static de.fdpg.dataportal_backend.query.collect.QueryStatus.FAILED;
import static de.fdpg.dataportal_backend.query.persistence.BrokerClientType.MOCK;
