...
public class JsonSchemaIdResolver implements SchemaIdResolver {
  ...
  public static final String CLASSPATH_CRTDL_SCHEMA_FILE = "classpath:de/numcodex/feasibility_gui_backend/query/api/validation/crtdl-schema.json";
  public static final String CLASSPATH_CCDL_SCHEMA_FILE = "classpath:de/numcodex/feasibility_gui_backend/query/api/validation/ccdl-schema.json";
  public static final String CLASSPATH_DATAQUERY_SCHEMA_FILE = "classpath:de/numcodex/feasibility_gui_backend/query/api/validation/dataquery-schema.json";
