package de.medizininformatikinitiative.dataportal.backend.query.broker;

import ca.uhn.fhir.context.FhirContext;
import de.medizininformatikinitiative.dataportal.backend.query.broker.mock.MockBrokerClient;
