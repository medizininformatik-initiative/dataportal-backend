...
public enum ValidationIssueType {
  ...
  ValidationIssueType(int code, String detail) {
    this.code = code;
    this.detail = detail;
  }

  public static ValidationIssueType valueOf(int validationIssueCode) {
    ValidationIssueType validationIssueType = resolve(validationIssueCode);
    if (validationIssueType == null) {
  ...
  @Nullable
  public static ValidationIssueType resolve(int validationIssueCode) {
    for (ValidationIssueType validationIssueType : VALUES) {
      if (validationIssueType.code == validationIssueCode) {
        return validationIssueType;
      }
    }
    return null;
