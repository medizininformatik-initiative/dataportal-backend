...
import de.fdpg.dataportal_backend.query.api.status.*;
import de.fdpg.dataportal_backend.query.api.validation.JsonSchemaValidator;
import de.fdpg.dataportal_backend.query.api.validation.StructuredQueryValidatorSpringConfig;
...
import de.fdpg.dataportal_backend.query.persistence.UserBlacklistRepository;
...
import de.fdpg.dataportal_backend.query.translation.QueryTranslationException;
...
public class FeasibilityQueryHandlerRestControllerIT {
  ...
  @NotNull
  private static de.fdpg.dataportal_backend.query.persistence.Query createValidQuery(long id) {
    var query = new de.fdpg.dataportal_backend.query.persistence.Query();
    query.setId(id);
  ...
  @NotNull
  private static de.fdpg.dataportal_backend.query.persistence.QueryContent createValidQueryContent(long id) {
    var queryContent = new de.fdpg.dataportal_backend.query.persistence.QueryContent();
