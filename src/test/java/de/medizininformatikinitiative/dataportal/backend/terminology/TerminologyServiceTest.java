...
class TerminologyServiceTest {
  ...
  void testAddDisplay(boolean matchingIds) throws IOException {
    var terminologyService = createTerminologyService();
    de.medizininformatikinitiative.dataportal.backend.common.api.TermCode tc = de.medizininformatikinitiative.dataportal.backend.common.api.TermCode.builder()
        .code("code")
        .system("system")
        .display("display")
        .version("version")
    ...
    CriteriaProfileData cpd = CriteriaProfileData.builder()
        .id("id")
        .context(de.medizininformatikinitiative.dataportal.backend.common.api.TermCode.builder()
            .code("code")
            .system("system")
            .display("display")
            .version("version")
  ...
  private UiProfile createUiProfile() throws JsonProcessingException {
    ...
    uiProfile.setUiProfile(jsonUtil.writeValueAsString(
        de.medizininformatikinitiative.dataportal.backend.terminology.api.UiProfile.builder()
            .name("ExampleProfile")
