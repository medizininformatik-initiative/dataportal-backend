...
class DseServiceTest {
  ...
  private de.medizininformatikinitiative.dataportal.backend.dse.api.DseProfile createDummyDseProfileEntry() {

    return de.medizininformatikinitiative.dataportal.backend.dse.api.DseProfile.builder()
