...
import de.medizininformatikinitiative.dataportal.backend.query.dataquery.DataqueryCsvExportService;
import de.medizininformatikinitiative.dataportal.backend.query.dataquery.DataquerySpringConfig;
import de.medizininformatikinitiative.dataportal.backend.query.dispatch.QueryDispatchSpringConfig;
import de.medizininformatikinitiative.dataportal.backend.query.dispatch.QueryHashCalculator;
...
import static de.medizininformatikinitiative.dataportal.backend.query.QueryHandlerService.ResultDetail.*;
import static de.medizininformatikinitiative.dataportal.backend.query.api.ValueFilterType.QUANTITY_COMPARATOR;
import static de.medizininformatikinitiative.dataportal.backend.query.persistence.ResultType.ERROR;
