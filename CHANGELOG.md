...
### Added
- New endpoint to fix potentially erratic CRTDLs ([#870](https://github.com/medizininformatik-initiative/dataportal-backend/issues/870))
...
### Added
- Improved error handling to improve ccdl and crtdl validation and provide more detailed error messages to allow for better messages in the UI ([#689](https://github.com/medizininformatik-initiative/dataportal-backend/issues/689))
### Changed
- Update ontology to [v3.9.5](https://github.com/medizininformatik-initiative/fhir-ontology-generator/releases/tag/v3.9.5) ([#833](https://github.com/medizininformatik-initiative/dataportal-backend/issues/833))
- Import all CA certificates in PEM file if it contains multiple ([#780](https://github.com/medizininformatik-initiative/dataportal-backend/issues/780))
- When executing feasibility queries, send a response to the frontend and spawn the actual execution asynchronously ([#836](https://github.com/medizininformatik-initiative/dataportal-backend/issues/836))
### Security
- Updated dependencies and GitHub actions

## [8.2.0] - 2026-01-21

- Based on ontology **[v3.9.4](https://github.com/medizininformatik-initiative/fhir-ontology-generator/releases/tag/v3.9.4)**

### Changed
- Update ontology to [v3.9.4](https://github.com/medizininformatik-initiative/fhir-ontology-generator/releases/tag/v3.9.3) ([#782](https://github.com/medizininformatik-initiative/dataportal-backend/issues/782))
